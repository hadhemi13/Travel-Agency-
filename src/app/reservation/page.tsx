                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 sticky top-20">
                                <h3 className="text-xl font-bold mb-4 text-gray-800 dark:text-white">Résumé de la
                                    réservation</h3>

                                {selectedRoom ? (
                                    <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Chambre
                                            sélectionnée:</p>
                                ...
                                <div className="space-y-3 mb-6">
                                    ...
                                    <div className="border-t border-gray-300 dark:border-gray-600 pt-3 mt-3">
                                        <div
                                            className="flex justify-between text-xl font-bold text-blue-600 dark:text-blue-400">
                                            <span>Total</span>
                                            <span>{finalTotalPrice.toFixed(2)} {pricing.currency}</span>
                                        </div>
                                        <p className="text-xs text-gray-600 dark:text-gray-400 text-right mt-1">Taxes et
                                            frais inclus</p>
                                    </div>
                                </div>
                                ...
                                <div className="mt-6 space-y-2 text-sm text-gray-600 dark:text-gray-400">
                                    <p className="flex items-start">
                                        <BsCheckCircle
                                            className="mr-2 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0"/>
                                ...
                                <div className="mt-4 flex gap-2">
                                    <button
                                        ...
                                        className={`flex-1 py-2 rounded-lg border transition-all ${
                                            generatingPDF || !selectedRoom || !isFormValid()
