  ...
  return (
    <section className="pt-0">
      <div className="container mx-auto px-3 sm:px-4">
        <div className="bg-light rounded-3 relative overflow-hidden p-4 sm:p-12">
          ...
          <div className="flex flex-wrap -mx-3 sm:-mx-4 gap-y-4 justify-center md:justify-between items-center relative">
            <div className="w-full xl:w-1/2 px-3 sm:px-4">
              <h4 className="mb-0">Subscribe Our Newsletter</h4>
            </div>
            <div className="w-full xl:w-5/12 px-3 sm:px-4">
              <form
                onSubmit={handleSubmit(() => {})}
                className="bg-body rounded-2 p-2"
              >
                <div className="flex">
                  <TextFormInput<{ email: string }>
                    name="email"
                    type="email"
                    combinedInput
                  ...
                  <button
                    type="submit"
                    className="btn btn-dark btn-round mb-0 flex-shrink-0 flex items-center justify-center"
                  >
